...
cp "${BIN_DIR}/CodexVitalsKeepAwake" "${OUT}/Contents/MacOS/CodexVitalsKeepAwake"
chmod +x "${OUT}/Contents/MacOS/CodexVitalsKeepAwake"
...
cp "${ROOT}/CREDITS.txt" "${OUT}/Contents/Resources/CREDITS.txt"
